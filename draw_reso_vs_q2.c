...
void draw_reso_vs_q2( const char* var = "x", const char* cuts = "" ) {
   ...
   sprintf( htitle, "%s resolution vs log10(Q2), DNN", var ) ;

   TProfile* tp_dnn = new TProfile( hname, htitle, nbins, xaxis_min, xaxis_max, yaxis_min, yaxis_max, "s" ) ;

   sprintf( arg1, "dnn_%s/true_%s:log10(true_q2)>>%s", var, var, hname ) ;
   ...
   sprintf( htitle, "%s resolution vs log10(Q2), e", var ) ;

   TProfile* tp_e = new TProfile( hname, htitle, nbins, xaxis_min, xaxis_max, yaxis_min, yaxis_max, "s" ) ;

   sprintf( arg1, "rec_%s_e/true_%s:log10(true_q2)>>%s", var, var, hname ) ;
   ...
   sprintf( htitle, "%s resolution vs log10(Q2), DA", var ) ;

   TProfile* tp_da = new TProfile( hname, htitle, nbins, xaxis_min, xaxis_max, yaxis_min, yaxis_max, "s" ) ;

   sprintf( arg1, "rec_%s_da/true_%s:log10(true_q2)>>%s", var, var, hname ) ;
   ...
   sprintf( htitle, "%s resolution vs log10(Q2), hadron", var ) ;

   TProfile* tp_h = new TProfile( hname, htitle, nbins, xaxis_min, xaxis_max, yaxis_min, yaxis_max, "s" ) ;

   sprintf( arg1, "rec_%s_h/true_%s:log10(true_q2)>>%s", var, var, hname ) ;
   ...
   sprintf( htitle, "%s resolution vs log10(Q2), ISigma", var ) ;

   TProfile* tp_is = new TProfile( hname, htitle, nbins, xaxis_min, xaxis_max, yaxis_min, yaxis_max, "s" ) ;

   sprintf( arg1, "rec_%s_is/true_%s:log10(true_q2)>>%s", var, var, hname ) ;
   ...
   hd_rms -> SetXTitle( "true log10(Q^{2})" ) ;
   ...
   hd_mean -> SetXTitle( "true log10(Q^{2})" ) ;
   ...
   sprintf( save_fname, "reso-plots/athena-rms-%s-vs-q2%s.pdf", var, cut_label ) ;
   can_rms -> SaveAs( save_fname ) ;

   sprintf( save_fname, "reso-plots/athena-rms-%s-vs-q2%s.png", var, cut_label ) ;
   can_rms -> SaveAs( save_fname ) ;
   ...
   sprintf( save_fname, "reso-plots/athena-mean-%s-vs-q2%s.pdf", var, cut_label ) ;
   can_mean -> SaveAs( save_fname ) ;

   sprintf( save_fname, "reso-plots/athena-mean-%s-vs-q2%s.png", var, cut_label ) ;
   can_mean -> SaveAs( save_fname ) ;
