...
#ifndef delphes_rapgap_isr_fsr_analysis_h
#define delphes_rapgap_isr_fsr_analysis_h
...
class delphes_rapgap_isr_fsr_analysis {
public :
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   delphes_rapgap_isr_fsr_analysis(TTree *tree=0);
   virtual ~delphes_rapgap_isr_fsr_analysis();
...
#ifdef delphes_rapgap_isr_fsr_analysis_cxx
delphes_rapgap_isr_fsr_analysis::delphes_rapgap_isr_fsr_analysis(TTree *tree) : fChain(0) 
{
...
delphes_rapgap_isr_fsr_analysis::~delphes_rapgap_isr_fsr_analysis()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t delphes_rapgap_isr_fsr_analysis::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t delphes_rapgap_isr_fsr_analysis::LoadTree(Long64_t entry)
{
...
void delphes_rapgap_isr_fsr_analysis::Init(TTree *tree)
{
...
Bool_t delphes_rapgap_isr_fsr_analysis::Notify()
{
...
void delphes_rapgap_isr_fsr_analysis::Show(Long64_t entry)
{
...
Int_t delphes_rapgap_isr_fsr_analysis::Cut(Long64_t entry)
{
...
#endif // #ifdef delphes_rapgap_isr_fsr_analysis_cxx
