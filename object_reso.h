...
#ifndef object_reso_h
#define object_reso_h
...
// TBranch        *b_dualRICHcfTrack_size;   //!
   ...
   object_reso( const char* infilename = "input.root" );
   virtual ~object_reso();
...
#ifdef object_reso_cxx
object_reso::object_reso( const char* infilename ) : fChain(0) 
{
...
object_reso::~object_reso()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t object_reso::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t object_reso::LoadTree(Long64_t entry)
{
...
void object_reso::Init(TTree *tree)
{
...
void object_reso::Show(Long64_t entry)
{
...
Int_t object_reso::Cut(Long64_t entry)
{
