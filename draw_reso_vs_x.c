...
void draw_reso_vs_x( const char* var = "x", const char* cuts = "" ) {
   ...
   sprintf( htitle, "%s resolution vs x, DNN", var ) ;

   TProfile* tp_dnn = new TProfile( hname, htitle, nbins, xaxis_min, xaxis_max, yaxis_min, yaxis_max, "s" ) ;

   sprintf( arg1, "dnn_%s/true_%s:true_x>>%s", var, var, hname ) ;
   ...
   sprintf( htitle, "%s resolution vs x, e", var ) ;

   TProfile* tp_e = new TProfile( hname, htitle, nbins, xaxis_min, xaxis_max, yaxis_min, yaxis_max, "s" ) ;

   sprintf( arg1, "rec_%s_e/true_%s:true_x>>%s", var, var, hname ) ;
   ...
   sprintf( htitle, "%s resolution vs x, DA", var ) ;

   TProfile* tp_da = new TProfile( hname, htitle, nbins, xaxis_min, xaxis_max, yaxis_min, yaxis_max, "s" ) ;

   sprintf( arg1, "rec_%s_da/true_%s:true_x>>%s", var, var, hname ) ;
   ...
   sprintf( htitle, "%s resolution vs x, hadron", var ) ;

   TProfile* tp_h = new TProfile( hname, htitle, nbins, xaxis_min, xaxis_max, yaxis_min, yaxis_max, "s" ) ;

   sprintf( arg1, "rec_%s_h/true_%s:true_x>>%s", var, var, hname ) ;
   ...
   sprintf( htitle, "%s resolution vs x, ISigma", var ) ;

   TProfile* tp_is = new TProfile( hname, htitle, nbins, xaxis_min, xaxis_max, yaxis_min, yaxis_max, "s" ) ;

   sprintf( arg1, "rec_%s_is/true_%s:true_x>>%s", var, var, hname ) ;
   ...
   sprintf( save_fname, "reso-plots/athena-rms-%s-vs-x%s.pdf", var, cut_label ) ;
   can_rms -> SaveAs( save_fname ) ;

   sprintf( save_fname, "reso-plots/athena-rms-%s-vs-x%s.png", var, cut_label ) ;
   can_rms -> SaveAs( save_fname ) ;
   ...
   sprintf( save_fname, "reso-plots/athena-mean-%s-vs-x%s.pdf", var, cut_label ) ;
   can_mean -> SaveAs( save_fname ) ;

   sprintf( save_fname, "reso-plots/athena-mean-%s-vs-x%s.png", var, cut_label ) ;
   can_mean -> SaveAs( save_fname ) ;
